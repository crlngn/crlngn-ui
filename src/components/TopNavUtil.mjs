...
export class TopNavigation {
  ...
  static onRender = (nav, navHtml, navData) => {
    ...
    if(TopNavigation.sceneNavEnabled && TopNavigation.useSceneFolders && TopNavigation.navShowRootFolders && foldersAllowed){
      SceneNavFolders.init();
  ...
  static handleFolderList(nav, navHtml, navData){
    const foldersAllowed = game.user?.isGM || TopNavigation.navFoldersForPlayers;
    if(!TopNavigation.useSceneFolders || !foldersAllowed){
